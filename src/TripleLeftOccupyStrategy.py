...
class TripleLeftOccupyStrategy(Strategy.Strategy):
    ...
    def init(self, tmpObj : SceneGenerator.SceneGenerator , strtTimeI : float ) :
        ...
        stime = tmpObj.leftHookHeadStrategy.initSegment(tmpObj, strtTimeA, randx, 0);
        ...
        stime2 = tmpObj.leftHookHeadStrategy.initSegment(tmpObj, strtTimeA, randx, 3);
        ...
        stime3 = tmpObj.leftHookHeadStrategy.initSegment(tmpObj, strtTimeA, randx, 6);
