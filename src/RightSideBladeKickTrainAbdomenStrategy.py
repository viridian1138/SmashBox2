...
class RightSideBladeKickTrainAbdomenStrategy(Strategy.Strategy):
    ...
    def init(self, tmpObj : SceneGenerator.SceneGenerator , strtTimeI : float ) :
        ...
        if  random.random() > 0.5 :
            strtTimeA = tmpObj.rightSideBladeKickAbdomenStrategy.initSegment(tmpObj, strtTimeA, tdelay, cameraPos, 3);
            strtTimeA = strtTimeA + 3.0 * ( tmpObj.jumpingKickDelay ); # was 0.5 *
        #if
