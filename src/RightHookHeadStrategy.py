...
class RightHookHeadStrategy(Strategy.Strategy):
    ...
    def initSegment(self, tmpObj : SceneGenerator.SceneGenerator, strtTimeI : float, randx : float , punchIndex : int ) :
        ...
        if True :
            startXA = 0.15;
            tobj = tmpObj.targetsPunchA[ punchIndex + 0 ];
            tobj.strtPos = Vec3.Vec3();
            tobj.endPos = Vec3.Vec3();
            tobj.strtPos.set(startXA, tmpObj.offenseHeight * (tmpObj.hookHeadHeight / tmpObj.idealHumanHeadHeights ), tmpObj.backDistBucket);
            tobj.endPos.set(startXA, tmpObj.offenseHeight * (tmpObj.hookHeadHeight / tmpObj.idealHumanHeadHeights ), 0);
        ...
        if True :
            startXA = 0.0;
            tobj = tmpObj.targetsPunchA[ punchIndex + 1 ];
            tobj.strtPos = Vec3.Vec3();
            tobj.endPos = Vec3.Vec3();
            tobj.strtPos.set(startXA, tmpObj.offenseHeight * (tmpObj.hookHeadHeight / tmpObj.idealHumanHeadHeights ), tmpObj.backDistBucket);
            tobj.endPos.set(startXA, tmpObj.offenseHeight * (tmpObj.hookHeadHeight / tmpObj.idealHumanHeadHeights ), 0);
        ...
        if True :
            startXA = -0.15;
            tobj = tmpObj.targetsPunchA[ punchIndex + 2 ];
            tobj.strtPos = Vec3.Vec3();
            tobj.endPos = Vec3.Vec3();
            tobj.strtPos.set(startXA, tmpObj.offenseHeight * (tmpObj.hookHeadHeight / tmpObj.idealHumanHeadHeights ), tmpObj.backDistBucket);
            tobj.endPos.set(startXA, tmpObj.offenseHeight * (tmpObj.hookHeadHeight / tmpObj.idealHumanHeadHeights ), 0);
