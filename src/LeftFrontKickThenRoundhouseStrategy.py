...
# Strategy for a defensive maneuver consisting of a left front-ball kick followed by a right roundhouse kick.
class LeftFrontKickThenRoundhouseStrategy(Strategy.Strategy):
    ...
    def init(self, tmpObj : SceneGenerator.SceneGenerator , strtTimeI : float ) :
        ...
        stime = tmpObj.leftRoundhouseKickStrategy.initSegment(tmpObj, strtTimeA + 8 * split2, randx, 6);
