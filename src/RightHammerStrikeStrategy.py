...
class RightHammerStrikeStrategy(Strategy.Strategy):
    ...
    def init(self, tmpObj : SceneGenerator.SceneGenerator , strtTimeI : float ) :
        ...
        if True :
            ...
            tobj.strtPos.set(startXA, tmpObj.offenseHeight * (tmpObj.hammerStrikeHeight / tmpObj.idealHumanHeadHeights ) + startXA, tmpObj.backDistBucket);
            tobj.endPos.set(startXA, tmpObj.offenseHeight * (tmpObj.hammerStrikeHeight / tmpObj.idealHumanHeadHeights ) + startXA, 0);
